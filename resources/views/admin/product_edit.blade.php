                ...
                <div class="flex flex-wrap">
                    ...
                    <div class="p-2 w-1/2">
                        <div class="relative">
                            ...
                            <input
                                ...
                                type="text" id="price" name="price" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" />
                        </div>
                        @error('price')
                            <div class="text-red-400 text-sm">{{$message}}</div>
                        @enderror
                    ...
                    <div class="p-2 w-1/2">
                        <div class="relative">
                            ...
                            <input 
                                ...
                                type="text" id="stock" name="stock" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                        </div>
                        @error('stock')
                            <div class="text-red-400 text-sm">{{$message}}</div>
                        @enderror
                    ...
                    <div class="p-2 w-1/2">
                        <div class="relative">
                            ...
                            <input 
                                value="{{$product->file}}"
                                type="file" id="cover" name="cover" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" />
                        </div>
                    ...
                    <div class="p-2 w-full">
                        <img 
                            ...
                            alt=""
                           >
                           <a href="{{ route('admin.product.destroyImagen', $product->id )}}">DELETAR IMAGEM</a>
                    </div>
                    @endif
                    <div class="p-2 w-full">
                        <div class="relative">
